...
2. **管线**（必填，给选项并解释）  
   ...
   - **C · 体系驱动**（`pipeline: "system"`）— 内部多模块 DOCX、交易策略/业务体系（如 `wiki/raw/业务认知/wyc交易策略`）→ **system-learn**  
   - 判定：年表/地质年代 → B；`wiki/raw/业务认知/*`、体系稿、交易策略、无教材但有内部文档 → C；否则 A
...
- **pipeline**：system
- **sourceRoot**：wiki/raw/业务认知/wyc交易策略
